    ...
    <>
      {data.versions.length === 0 ? (
        ...
        <div className={styles.workspace}>
          ...
          >
            <span className={styles.columnHeading}>Production Versions</span>
            <div className={styles.selectorList}>
              {data.versions.map(({ version, reviewNotes }, index) => {
                const isActive = selected?.version.id === version.id;
                const isLatestChip = version.id === data.item.latest_version_id;
                return (
                ...
                <div className={styles.selectedVersionSurface}>
                    ...
                    <div className={styles.versionObjectRow}>
                      ...
                      <div className={styles.versionObjectBody}>
                        ...
                        <p className={styles.versionMeta}>
                          ...
                          {selected.reviewNotes.length === 1 ? "note" : "notes"}
                        </p>
                        {!isLatestVersion && data.item.latest_version_name && (
                  ...
                  >
                    ...
                    <dl className={styles.evidenceGrid}>
                      ...
                      <div className={styles.evidenceField}>
                        <dt className={styles.evidenceLabel}>Core Anchor</dt>
                        <dd className={styles.evidenceValue}>
                  ...
                  <div className={styles.agentCanvas}>
                        ...
                        <>
                          ...
                          <p className={styles.executiveSummary}>
                            {buildAgentTakeaway(
                              ...
                              data.activeExecutionRevision?.revision_number ??
                                null,
                            )}
                          </p>
                        </>
                    ...
                    {currentReview && (
                      <div className={styles.agentRight}>
                        ...
                        <SignalStrip
                          items={signalStripItems(currentReview.review_output)}
                        />
                      </div>
                    )}
                  </div>
                      ...
                      <details className={styles.disclosure}>
                        ...
                        <div className={styles.disclosureContent}>
                          ...
                          <ReviewItemGroup
                            ...
                            items={
                              currentReview.review_output.coordination_concerns
                            }
                          />
                          <ReviewItemGroup
                          ...
                          />
                          {currentReview.review_output
                            .questions_for_human_cg_supervisor.length > 0 && (
                            <section className={styles.findingGroup}>
                              <h4 className={styles.findingGroupTitle}>
                          ...
                          {currentReview.review_output.evidence_gaps.length >
                            0 && (
                            <section className={styles.findingGroup}>
                              <h4 className={styles.findingGroupTitle}>
                                Evidence gaps (
                          ...
                          >
                            <div className={styles.detailFooter}>
                              <div className={styles.detailFooterItem}>
                                ...
                                <p>
                                  Advisory technical interpretation; it does not
                                  approve the Version or resolve a Human
                                  Decision.
                                </p>
                              </div>
                              <div className={styles.detailFooterItem}>
                                ...
                                <p>
                                  Inspect the Agent review, then record a Review
                                  Note, dependency, or escalation if needed.
                                </p>
                              </div>
                              <div className={styles.detailFooterItem}>
                                <span className={styles.evidenceLabel}>
                                ...
                                <p>
                                  Detailed Agent provenance is unavailable for
                                  this output.
                                </p>
                              </div>
                            </div>
